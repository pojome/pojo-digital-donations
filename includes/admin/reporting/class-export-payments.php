...
class PDD_Payments_Export extends PDD_Export {
	...
	public function csv_cols() {
		...
		$cols = array(
			...
			'tax'      => __( 'Tax', 'pdd' ) . ' (' . html_entity_decode( pdd_currency_filter( '' ) ) . ')',
			'discount' => __( 'Discount Code', 'pdd' ),
	...
	public function get_data() {
		...
		foreach ( $payments as $payment ) {
			...
			$data[] = array(
				...
				'discount' => isset( $user_info['discount'] ) && $user_info['discount'] != 'none' ? $user_info['discount'] : __( 'none', 'pdd' ),
